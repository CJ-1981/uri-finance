...
- **Multi-User Projects**: Create projects, invite team members with role-based access control, and manage your project list with **custom drag-and-drop ordering and default (starred) selection**.
