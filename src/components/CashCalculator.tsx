    ...
    <div className="space-y-3">
      ...
      <div className="glass-card p-3 space-y-1.5">
        ...
        {targetAmount > 0 && (() => {
          ...
          const statusColor = isMatch ? "text-primary" : isExcess ? "text-income" : "text-expense";
          const bgColor = isMatch ? "bg-primary/10" : isExcess ? "bg-income/10" : "bg-expense/10";
          const borderColor = isMatch ? "border-primary/30" : isExcess ? "border-income/30" : "border-expense/30";
          return (
            <>
