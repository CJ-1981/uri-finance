...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "report.clearComments": "Clear Comments",
    "report.clearCommentsTitle": "Clear All Comments?",
    "report.clearCommentsDesc": "This will permanently delete all comments from the summary table. This action cannot be undone.",
    "report.clearCommentsConfirm": "Clear All",
    "report.total": "Total",
  ...
  ko: {
    ...
    "report.clearComments": "메모 지우기",
    "report.clearCommentsTitle": "모든 메모를 삭제하시겠습니까?",
    "report.clearCommentsDesc": "요약 테이블의 모든 메모가 영구적으로 삭제됩니다. 이 작업은 되돌릴 수 없습니다.",
    "report.clearCommentsConfirm": "모두 삭제",
    "report.total": "합계",
