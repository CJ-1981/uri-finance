...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "auth.rateLimitError": "Too many requests. Please wait a while before trying again.",
    "auth.invalidLink": "Invalid or Expired Link",
    "auth.invalidLinkDesc": "The password reset link is invalid or has expired. Please request a new one.",
    ...
    "auth.recoveryModeDesc": "You can now set a new password for your account.",
    ...
    "proj.offlineSwitch": "Cannot switch projects while offline",
    "proj.offlineCreate": "Cannot create projects while offline",
    "proj.offlineJoin": "Cannot join projects while offline",
    "proj.offlineDelete": "Cannot delete projects while offline",
    "proj.reorder": "Reorder projects",
    "proj.setDefault": "Set as default",
    "proj.default": "Default",
    "proj.defaultProject": "Default project",
    "proj.removeDefault": "Remove default",
    ...
    "admin.itemsSelected": "{count} {count, plural, one {item} other {items}} selected",
  ...
  ko: {
    ...
    "auth.resetPasswordError": "비밀번호 재설정 이메일 전송에 실패했습니다. 다시 시도해주세요.",
    "auth.rateLimitError": "요청이 너무 많습니다. 잠시 후 다시 시도해주세요.",
    "auth.invalidLink": "유효하지 않거나 만료된 링크",
    "auth.invalidLinkDesc": "비밀번호 재설정 링크가 유효하지 않거나 만료되었습니다. 새로운 링크를 요청해주세요.",
    ...
    "auth.recoveryModeDesc": "이제 계정의 새 비밀번호를 설정할 수 있습니다.",
    ...
    "proj.offlineSwitch": "오프라인 상태에서는 프로젝트를 전환할 수 없습니다",
    "proj.offlineCreate": "오프라인 상태에서는 프로젝트를 만들 수 없습니다",
    "proj.offlineJoin": "오프라인 상태에서는 프로젝트에 참여할 수 없습니다",
    "proj.offlineDelete": "오프라인 상태에서는 프로젝트를 삭제할 수 없습니다",
    "proj.reorder": "프로젝트 순서 변경",
    "proj.setDefault": "기본값으로 설정",
    "proj.default": "기본",
    "proj.defaultProject": "기본 프로젝트",
    "proj.removeDefault": "기본값 제거",
    ...
    "admin.itemsSelected": "{count}개 선택됨",
