  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-red": {
          "0%": { boxShadow: "0 0 0 0 hsl(var(--destructive) / 0.6)" },
          "70%": { boxShadow: "0 0 0 20px hsl(var(--destructive) / 0)" },
      ...
      animation: {
        ...
        "pulse-red": "pulse-red 0.8s ease-out",
        "dot-pop": "dot-pop 0.4s ease-out",
      },
    },
  },
